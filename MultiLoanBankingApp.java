...
public class MultiLoanBankingApp {
    ...
    public static void main(String[] args) {
        ...
        JLabel footer = new JLabel("Built with ❤️ by Yuvaraj & ChatGPT");
        footer.setBounds(20, 640, 400, 20);
        frame.add(footer);
        ...
        clearLogBtn.addActionListener(e -> {
            ...
            if (result == JOptionPane.YES_OPTION) {
                try {
                    ...
                    fw.write(""); fw.close();
                    logArea.setText("Transaction Log:\n");
                    appendLog(logArea, "Transaction log cleared by user.");
                    writeToLog("Transaction log cleared by user.");
                } catch (IOException ex) {
